...
🎯 **Focus: [SkillHub.shop](https://skillhub.shop) — making AI agents accessible. Real company, real revenue, real agents.**
...
### 🌐 Live now
- **[skillhub.shop](https://skillhub.shop)** — primary domain (active)
...
- GitHub Pages → custom domain (`skillhub.shop`)
- Lemonsqueezy / Stripe Payment Links for checkout
- One-file HTML, no build step

### 📬 Get in touch
- SkillHub: [skillhub.shop](https://skillhub.shop)
- GitHub: [@gsantana212](https://github.com/gsantana212)

---

<sub>Last refocused: 2026-06-23 — shipped > scattered. One thing, done well.</sub>
